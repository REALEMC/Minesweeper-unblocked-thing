    ...
    function checkForWin() {
      ...
      for (let i = 0; i < squares.length; i++) {
        ...
        if (matches === bombAmount) {
          ...
          timer.innerHTML = 'WIN'
          emojiBtn.innerHTML = '😎';
          result.innerHTML = 'Congrats for completing the minesweeper here is the google doc link : https://docs.google.com/document/d/1s3c9xw7urJf_4pAxJk_U9yF_uWGC5W_SZyVax5Bk42Q';
          isGameOver = true;
        }
      }
    }
